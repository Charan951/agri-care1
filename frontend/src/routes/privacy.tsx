...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — AgriCare" },
      { name: "description", content: "How AgriCare collects, uses, and protects your data." },
    ],
  }),
  component: Privacy,
});
  ...
  return (
    <>
      <PageHero
        ...
        description="This policy is maintained by AgriCare to explain how we handle personal information. Last updated June 28, 2026."
        compact
      />
      <Section>
        <div className="prose-content mx-auto max-w-3xl space-y-6 text-[15px] leading-relaxed text-foreground">
          <p>This page summarizes AgriCare's privacy practices for the website and mobile apps operated by AgriCare Technologies Pvt. Ltd. It is informational and not a substitute for legal advice.</p>
          ...
          <p>You can access, correct, export, or delete your data anytime from Settings, or by writing to privacy@AgriCare.in.</p>
          ...
          <p>Questions? Email privacy@AgriCare.in or write to our Bengaluru office.</p>
        </div>
      </Section>
    </>
  );
