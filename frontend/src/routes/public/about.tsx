...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About AgriCare — Our mission to modernize Indian farming" },
      { name: "description", content: "We're building the operating system for India's 140 million farmers." },
      { property: "og:title", content: "About AgriCare" },
  ...
  return (
    <>
      <PageHero
        ...
        description="AgriCare is an enterprise AgriTech platform helping 50,000+ farmers grow better with AI, data, and a trusted supply chain."
        image={IMG.organic}
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              ...
              that powers the world's most productive farms. AgriCare is building that operating system.
            </p>
          </div>
          <div>
      ...
      <Section className="!pt-0">
        <SectionHeader eyebrow="Leadership" title="The team behind AgriCare." />
