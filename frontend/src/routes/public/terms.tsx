...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions — AgriCare" },
      { name: "description", content: "The terms that govern your use of AgriCare." },
    ],
  }),
  component: Terms,
});
  ...
  return (
    <>
      <PageHero
        ...
        description="By using AgriCare you agree to these terms. Last updated June 28, 2026."
        compact
      />
      <Section>
        <div className="prose-content mx-auto max-w-3xl space-y-6 text-[15px] leading-relaxed text-foreground">
          ...
          <p>By creating an account or using any AgriCare service, you agree to these terms.</p>
          ...
          <p>Listings are provided by third-party merchants. AgriCare verifies merchants and price-matches but is not the seller of record unless explicitly stated.</p>
          ...
          <p>To the maximum extent permitted by law, AgriCare's liability is limited to the amount you paid for the relevant service in the prior 12 months.</p>
