...
export const Route = createFileRoute("/blog/$slug")({
  head: ({ params }) => ({
    meta: [
      { title: `${params.slug.replace(/-/g, " ")} — AgriCare Blog` },
      { name: "description", content: "Field-tested insights from AgriCare agronomists and engineers." },
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose-content mt-10 space-y-6 text-[17px] leading-relaxed text-foreground">
            ...
            <ul className="ml-5 list-disc space-y-2 text-muted-foreground">
              ...
              <li>Compare against last week's photos in the AgriCare app.</li>
