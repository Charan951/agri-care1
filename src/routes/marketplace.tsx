...
const PRODUCTS = [
  { id: "p-1", name: "Hybrid Tomato Seeds (10g)", price: "₹240", rating: 4.8, img: IMG.vegetables, badge: "Best seller" },
  { id: "p-2", name: "Organic Vermicompost (25kg)", price: "₹540", rating: 4.7, img: IMG.organic, badge: "Eco" },
  { id: "p-3", name: "Drip Irrigation Kit (1 acre)", price: "₹18,900", rating: 4.9, img: IMG.irrigation, badge: "Pro" },
  { id: "p-4", name: "Cordless Sprayer 16L", price: "₹3,450", rating: 4.6, img: IMG.equipment, badge: "New" },
  { id: "p-5", name: "Wheat Seed HD-3226 (40kg)", price: "₹1,650", rating: 4.7, img: IMG.wheat, badge: "Top pick" },
  { id: "p-6", name: "NPK 19-19-19 (50kg)", price: "₹1,420", rating: 4.5, img: IMG.organic, badge: "Bulk" },
  { id: "p-7", name: "Mini Power Tiller", price: "₹52,000", rating: 4.8, img: IMG.equipment, badge: "Pro" },
  { id: "p-8", name: "Drone Sprayer 10L", price: "₹2,40,000", rating: 4.9, img: IMG.ai, badge: "Premium" },
];
    ...
    <>
      ...
      <Section>
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
          {CATEGORIES.map((c) => (
            <Link to="/marketplace" key={c.name} className="card-soft card-soft-hover group overflow-hidden">
      ...
      <Section className="!pt-0">
        <div className="flex items-end justify-between gap-6">
          <SectionHeader eyebrow="Featured" title="Top-rated products." />
